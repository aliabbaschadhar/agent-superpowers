...
const CATEGORY_RULES = [
  // ── GAME DEVELOPMENT ─────────────────────────────────────────────────────────
  {
    ...
    keywords: [
      ...
      /\bshader\b/i,
      /\blevel.design\b/i,
      /\bprocedural.generation\b/i,
      /\bgame.multiplayer\b/i,
      /\bnetcode\b/i,
    ],
  },
  ...
  // ── LIBREOFFICE / OFFICE ──────────────────────────────────────────────────────
  {
    ...
    keywords: [
      /\blibreoffice\b/i,
      /\bms.office\b/i,
      /\bmicrosoft.office\b/i,
      /\bword\b/i,
      /\bexcel\b/i,
      /\bpowerpoint\b/i,
      /\bspreadsheet\b/i,
      /\bworkbook\b/i,
      /\bpresentation.slide\b/i,
      /\boffice.suite\b/i,
      /^libreoffice/i,
      /^ms-office/i,
      /^office-/i,
  ...
  // ── SECURITY ─────────────────────────────────────────────────────────────────
  {
    ...
    keywords: [
      ...
      /\bblastone\b/i,
      /\bbsides\b/i,
      /\bactive.directory.attack\b/i,
      /\bkerberoast\b/i,
      /\bdcsync\b/i,
      /\bpass.the.hash\b/i,
      /\bgolden.ticket\b/i,
      /\bbloodhound\b/i,
      /\baws.penetration\b/i,
      /\bapi.fuzzing\b/i,
      /\banti.reversing\b/i,
      /\bpayload\b/i,
      /\bzerologon\b/i,
  ...
  // ── BACKEND / SERVER-SIDE ─────────────────────────────────────────────────────
  {
    ...
    keywords: [
      ...
      /\bthrift\b/i,
      /\bwebsocket\b/i,
      /\bserver.sent.event\b/i,
      /\bsse\b/i,
      /\bmicroservice\b/i,
      /\bmonolith\b/i,
      /\barchitecture.pattern\b/i,
    ],
  },
  ...
  // ── WORKFLOW / PLANNING ───────────────────────────────────────────────────────
  {
    ...
    keywords: [
      ...
      /\bconductor\b/i,
      /\bcontext.manage\b/i,
      /\bcontext.compress\b/i,
      /\bcontext.driven\b/i,
      /\bcontext.fundamental\b/i,
      /\bcontext.save\b/i,
      /\bcontext.restore\b/i,
      /\bcontext.degradat\b/i,
      /\bparallel.agent\b/i,
      /\bdispatching\b/i,
      /\bsubagent\b/i,
      /\bexecuting.plan\b/i,
  ...
  // ── SEARCH / WEB RESEARCH ─────────────────────────────────────────────────────
  {
    ...
    keywords: [
      ...
      /\bmarket.sizing\b/i,
      /\bmarket.opportunit\b/i,
      /\bmarket.research\b/i,
      /\bwiki.qa\b/i,
      /\bwiki.researcher\b/i,
      /\blast30days\b/i,
    ],
  },
  ...
  // ── STARTUP / BUSINESS ANALYSIS ───────────────────────────────────────────────
  {
    ...
    keywords: [
      /\bstartup\b/i,
      /\bfinancial.model/i,
      /\bfinancial.project/i,
      /\bbusiness.analys/i,
      /\bmarket.opportunit/i,
      /\btam\b/i,
      /\bmicro.saas\b/i,
      /\bsaas.launch\b/i,
      /\bpersonal.tool.build/i,
      /\bproduct.launch\b/i,
      /\blaunch.strategy\b/i,
      /\bviral.generator\b/i,
  ...
  // ── SUPPLY CHAIN / OPERATIONS ─────────────────────────────────────────────────
  {
    ...
    keywords: [
      ...
      /\binventor/i,
      /\bdemand.plan/i,
      /\bproduction.schedul/i,
      /\bquality.nonconform/i,
      /\breturns.reverse\b/i,
      /\breverse.logistic\b/i,
      /\bwarehouse\b/i,
      /\blogistic\b/i,
      /\bprocurement\b/i,
    ],
  ...
  {
    category: 'mobile',
    keywords: [/\bhig.component\b/i, /\bhig.platform\b/i, /\bapple.hig\b/i, /^hig-/i],
  },
  ...
  // ── CREATIVE / ART ───────────────────────────────────────────────────────────
  {
    category: 'creative',
    keywords: [
      /\balgorithmic.art\b/i,
      /\bgenerative.art\b/i,
      /\bscroll.experience\b/i,
      /\binteractive.portfolio\b/i,
      /\bportfolio.design\b/i,
      /\bp5\.js\b/i,
      /\bcreative.cod/i,
      /\bdigital.art\b/i,
    ],
  ...
  // ── CONSULTING / BUSINESS ─────────────────────────────────────────────────────
  {
    ...
    keywords: [
      /\bconsult\b/i,
      /\bbusiness.strateg/i,
      /\benterprise.architect/i,
      /\bdigital.transform/i,
      /\bstakeholder\b/i,
      /\bchange.manage/i,
      /\bprocess.improve/i,
      /\blean\b/i,
