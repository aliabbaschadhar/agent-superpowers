...
export const TECH_SKILL_MAP: Record<string, string[]> = {
  // ── Frontend ────────────────────────────────────────────────────────────────
  react: ['react-patterns', 'react-best-practices', 'react-state-management', 'react-ui-patterns', 'react-nextjs-development'],
  next: ['nextjs-best-practices', 'nextjs-app-router-patterns', 'react-patterns', 'react-nextjs-development'],
  nextjs: ['nextjs-best-practices', 'nextjs-app-router-patterns', 'react-patterns', 'react-nextjs-development'],
  vue: ['frontend-developer', 'frontend-design', 'javascript-pro'],
  angular: ['angular', 'angular-best-practices', 'angular-state-management', 'angular-ui-patterns', 'angular-migration'],
  ...
  // ── Node / Backend ──────────────────────────────────────────────────────────
  express: ['nodejs-backend-patterns', 'nodejs-best-practices', 'api-design-principles', 'backend-dev-guidelines'],
  ...
  // ── Python ──────────────────────────────────────────────────────────────────
  python: ['python-patterns', 'python-pro', 'python-testing-patterns', 'async-python-patterns', 'python-performance-optimization'],
  fastapi: ['fastapi-pro', 'fastapi-templates', 'fastapi-router-py', 'python-patterns', 'api-design-principles'],
...
export const TECH_DISPLAY_NAMES: Record<string, string> = {
  react: 'React', next: 'Next.js', nextjs: 'Next.js', vue: 'Vue', angular: 'Angular',
  svelte: 'Svelte', tailwindcss: 'Tailwind', tailwind: 'Tailwind', vite: 'Vite',
